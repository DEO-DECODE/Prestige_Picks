...
const Header = () => {
  ...
  return (
    <>
      <nav
        className="navbar navbar-expand-lg bg-warning fixed-top "
        style={{ color: "#fbb72c" }}
      >
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
            <Link to="/" className="navbar-brand logoText">
              <div><FontAwesomeIcon icon={faShoppingCart} /> Prestige Picks</div>
            </Link>
